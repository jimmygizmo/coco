...
# 2. create the virtual environment using the name : ve.coco
pyenv virtualenv 3.10.6 ve.coco

# And now the ve.coco virtual env should be active if all was done correctly.
...
# /Users/your_username/.pyenv/versions/ve.coco/bin/python
